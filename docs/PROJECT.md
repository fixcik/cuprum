...
*Ревизия 2026-06-16. Обновлять по мере фиксации новых решений. Последнее изменение: уточнение системы координат центровки по реперам — рабочие (G54) координаты, а не машинные.*
