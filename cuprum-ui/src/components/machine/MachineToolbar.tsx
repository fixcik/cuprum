...
/** Status/connection toolbar: ConnBar on the left, a feed/spindle mini-readout +
 *  big StatusPill + compact E-Stop on the right. The E-Stop is the Phase-1
 *  emergency stop: it fires a soft reset immediately, without confirmation. */
