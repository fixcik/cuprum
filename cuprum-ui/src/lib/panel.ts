...
/** Default stackup for a fresh blank: 1 oz copper on 1.6 mm FR4. */
...
export const BUILTIN_PANEL_PRESETS: PanelPreset[] = [
  { id: "builtin-100x100", name: "100 × 100 · 1oz · 1.6мм", widthMm: 100, heightMm: 100, stackup: { copper_weight_oz: 1, substrate_thickness_mm: 1.6 } },
  { id: "builtin-100x150", name: "100 × 150 · 1oz · 1.6мм", widthMm: 100, heightMm: 150, stackup: { copper_weight_oz: 1, substrate_thickness_mm: 1.6 } },
  { id: "builtin-200x100", name: "200 × 100 · 1oz · 1.6мм", widthMm: 200, heightMm: 100, stackup: { copper_weight_oz: 1, substrate_thickness_mm: 1.6 } },
];
