...
describe("evaluate — size", () => {
  ...
  it("warns when it fits only rotated and rotation is allowed (panel present)", () => {
    ...
    const panel = { schema_version: 5, width_mm: 160, height_mm: 100, origin_x_mm: 0, origin_y_mm: 0, instances: [], tooling_holes: [], keep_out_zones: [], alignment_points: [], drill_class_overrides: {} };
  ...
  it("blocks when the board does not fit the panel in any orientation", () => {
    ...
    const panel = { schema_version: 5, width_mm: 200, height_mm: 200, origin_x_mm: 0, origin_y_mm: 0, instances: [], tooling_holes: [], keep_out_zones: [], alignment_points: [], drill_class_overrides: {} };
